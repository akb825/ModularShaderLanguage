...
* `METAL_VERSION`: (OS X or iOS Metal target only) The metal version times 10. (e.g. 10, 11)
* `METAL_OSX_VERSION`: (OS X Metal target only) The metal version times 10. (e.g. 11, 12)
